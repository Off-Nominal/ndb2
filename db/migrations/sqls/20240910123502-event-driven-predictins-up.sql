...
-- trigger function to update last_check_date on insert to snooze_checks
...
CREATE TRIGGER prediction_last_check_date_from_snooze_checks AFTER INSERT ON snooze_checks
