...
/** Compositions → utilities → blocks: `screen-element`, `ring`, `appearance-none`, then `button` (block). */
const BASE_CLASS = "[ screen-element glass-primary-frost ] [ ring ] [ appearance-none ] [ button ]";
